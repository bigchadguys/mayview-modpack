...
╭────────────────────────────────────────────────────────────────────╮
│ FILE     : modifyFishWrapRecipe.js                                 │
│ LAYER    : server_scripts                                          │
│ DOMAIN   : recipes                                                 │
│ PURPOSE  : Fish Wrap Recipe                                        │
│ WARN     : Removed Existing Recipe and Rebuilding                  │
│ UPDATED  : 2026-02-14                                              │
╰────────────────────────────────────────────────────────────────────╯
*/
console.info("[RES:CORE] Initializing modifyFishWrapRecipe.js");
...
ServerEvents.recipes(event => {
  ...
  const recipeOutput = "valheim_delight:fish_wrap"
  const containerId = "culturaldelights:tortilla"
