...
╭────────────────────────────────────────────────────────────────────╮
│ FILE     : modifyBroccoliSoupRecipe.js                             │
...
╰────────────────────────────────────────────────────────────────────╯
*/
console.info("[RES:CORE] Initializing modifyBroccoliSoupRecipe.js");

ServerEvents.recipes(event => {
  // Array of Recipe Ingredients
  const recipeIngredients = [
    { tag: "c:foods/broccoli" },
    { tag: "c:foods/broccoli" },
    { tag: "c:drinks/milk" }
  ]
  const recipeOutput = "veggiesdelight:broccoli_soup"
