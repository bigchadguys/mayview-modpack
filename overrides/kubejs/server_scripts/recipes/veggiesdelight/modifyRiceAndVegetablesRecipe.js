...
╭────────────────────────────────────────────────────────────────────╮
│ FILE     : modifyRiceAndVegetablesRecipe.js                        │
│ LAYER    : server_scripts                                          │
│ DOMAIN   : recipes                                                 │
│ PURPOSE  : Rice and Vegetables Recipe                              │
│ WARN     : Removed Existing Recipe and Rebuilding                  │
│ UPDATED  : 2026-02-19                                              │
╰────────────────────────────────────────────────────────────────────╯
*/
console.info("[RES:CORE] Initializing modifyRiceAndVegetablesRecipe.js");
...
ServerEvents.recipes(event => {
  ...
  const recipeIngredients = [
    ...
    { tag: "c:crops/rice" },
    { tag: "c:crops/onion" },
    { tag: "c:foods/zucchini" },
    { tag: "c:foods/vegetables" }
  ]
  const recipeOutput = "veggiesdelight:rice_and_vegetables"
