...
╭────────────────────────────────────────────────────────────────────╮
│ FILE     : modifyEndermiteStewRecipe.js                            │
│ LAYER    : server_scripts                                          │
│ DOMAIN   : recipes                                                 │
│ PURPOSE  : Endermite Stew Recipe                                   │
│ WARN     : Removed Existing Recipe and Rebuilding                  │
│ UPDATED  : 2026-02-19                                              │
╰────────────────────────────────────────────────────────────────────╯
*/
console.info("[RES:CORE] Initializing modifyEndermiteStewRecipe.js");
...
ServerEvents.recipes(event => {
  ...
  const recipeOutput = "endersdelight:endermite_stew"
  const containerId = "endersdelight:shulker_bowl"
