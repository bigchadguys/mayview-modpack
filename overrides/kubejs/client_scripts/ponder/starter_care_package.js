  ...
  event
    ...
    .scene(
      ...
      (scene, util) => {
        ...
        scene.idle(1)
        // ══▣ Drop Items and Hover Items ▣═════════════════════════════════════════════════
        dropHover("ftbquests:book", 1, 0.08, 0.25, 0.02)
        scene.idle(2)
        dropHover("cobblemon:poke_ball", 1, -0.07, 0.25, -0.05)
        scene.idle(2)
        dropHover("cobblemon:pokedex_pink", 1, 0.02, 0.25, -0.02)
